...
| **[Agent Session Linting Spec](./AGENT_SESSION_LINT_SPEC.md)** | 9 rules for auditing agent session data (history, memory) across 8 agents. Covers cross-project secret consistency, config drift, stale memory, and loop detection.                                                                       |
